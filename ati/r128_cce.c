...
void
ati_r128_stop_cce_engine(ati_device_t *dev)
{
...
void
ati_r128_write_microcode(ati_device_t *dev, uint8_t addr, uint64_t inst)
{
...
int
ati_r128_cce_wait_for_idle(ati_device_t *dev)
{
