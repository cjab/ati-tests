// Auto-generated from registers/common.yaml - DO NOT EDIT
// Generated by: bin/generate_registers --chip common
//
// Common (shared between R128 and R100) register definitions.
//
...
#ifndef COMMON_REGS_GEN_H
#define COMMON_REGS_GEN_H
...
enum {
    PC_FLUSH_GUI_SHIFT = 0,
    PC_FLUSH_GUI_MASK = 0x3u,
    PC_RI_GUI_SHIFT = 2,
    PC_RI_GUI_MASK = 0xcu,
    PC_FLUSH_NONGUI_SHIFT = 4,
    PC_FLUSH_NONGUI_MASK = 0x30u,
    PC_RI_NONGUI_SHIFT = 6,
    PC_RI_NONGUI_MASK = 0xc0u,
    PC_PURGE_GUI = (1u << 8),
    PC_PURGE_NONGUI = (1u << 9),
    PC_DIRTY = (1u << 24),
    PC_PURGE_DOPURGE = (1u << 25),
    PC_FLUSH_DOFLUSH = (1u << 26),
    PC_BUSY_INIT = (1u << 27),
    PC_BUSY_FLUSH = (1u << 28),
    PC_BUSY_GUI = (1u << 29),
    PC_BUSY_NGUI = (1u << 30),
