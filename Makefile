...
COMMON_SRCS = main.c tests/error.c ati/ati.c ati/r128.c ati/r100.c ati/cce.c ati/r128_cce.c ati/r100_cce.c repl/repl.c repl/cce_cmd.c repl/pkt_cmd.c repl/dump_cmd.c $(TEST_SRCS)
