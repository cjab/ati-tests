...
static const field_entry_t crtc_gen_cntl_fields[] = {
    {"CRTC_DBL_SCAN_EN", 0, 1},
    {"CRTC_INTERLACE_EN", 1, 1},
    {"CRTC_C_SYNC_EN", 4, 1},
    {"CRTC_PIX_WIDTH", 8, 3},
    {"CRTC_CUR_EN", 16, 1},
    {"CRTC_CUR_MODE", 17, 3},
    {"CRTC_EXT_DISP_EN", 24, 1},
    {"CRTC_EN", 25, 1},
    {"CRTC_DISP_REQ_EN_B", 26, 1},
    {NULL, 0, 0}
};

static const field_entry_t crtc_ext_cntl_fields[] = {
    {"CRTC_VGA_XOVERSCAN", 0, 1},
    {"VGA_BLINK_RATE", 1, 2},
    {"VGA_ATI_LINEAR", 3, 1},
    {"VGA_128KAP_PAGING", 4, 1},
    {"VGA_TEXT_132", 5, 1},
    {"VGA_XCRT_CNT_EN", 6, 1},
    {"CRTC_HSYNC_DIS", 8, 1},
    {"CRTC_VSYNC_DIS", 9, 1},
    {"CRTC_DISPLAY_DIS", 10, 1},
    {"CRTC_SYNC_TRISTATE", 11, 1},
    {"CRTC_HSYNC_TRISTATE", 12, 1},
    {"CRTC_VSYNC_TRISTATE", 13, 1},
    {"CRTC_CRT_ON", 15, 1},
    {"VGA_CUR_B_TEST", 17, 1},
    {"VGA_PACK_DIS", 18, 1},
    {"VGA_MEM_PS_EN", 19, 1},
    {"VGA_READ_PREFETCH_DIS", 20, 1},
    {"DFIFO_EXTSENSE", 21, 1},
    {"FP_OUT_EN", 22, 1},
    {"FP_ACTIVE", 23, 1},
    {"VCRTC_IDX_MASTER", 24, 7},
    {NULL, 0, 0}
};
...
static const field_entry_t crtc_h_sync_strt_wid_fields[] = {
    {"CRTC_H_SYNC_STRT_PIX", 0, 3},
    {"CRTC_H_SYNC_STRT_CHAR", 3, 9},
    {"CRTC_H_SYNC_WID", 16, 6},
    {"CRTC_H_SYNC_POL", 23, 1},
    {NULL, 0, 0}
};
...
static const field_entry_t crtc_v_sync_strt_wid_fields[] = {
    {"CRTC_V_SYNC_STRT", 0, 11},
    {"CRTC_V_SYNC_WID", 16, 5},
    {"CRTC_V_SYNC_POL", 23, 1},
    {NULL, 0, 0}
};
...
static const field_entry_t dac_cntl_fields[] = {
    ...
    {"DAC_CMP_OUTPUT", 7, 1},
    {"DAC_8BIT_EN", 8, 1},
    {"DAC_4BPP_PIX_ORDER", 9, 1},
    {"DAC_TVO_EN", 10, 1},
    {"DAC_TVO_OVR_EXCL", 11, 1},
    {"DAC_TVO_16BPP_DITH_EN", 12, 1},
    {"DAC_VGA_ADR_EN", 13, 1},
    {"DAC_PDWN", 15, 1},
    {"DAC_CRC_EN", 19, 1},
    {"DAC_MASK", 24, 8},
...
static const field_entry_t gen_int_cntl_fields[] = {
    {"CRTC_VBLANK_INT_EN", 0, 1},
    {"CRTC_VLINE_INT_EN", 1, 1},
    {"CRTC_VSYNC_INT_EN", 2, 1},
    {"SNAPSHOT_INT_EN", 3, 1},
    {"FP_DETECT_INT_EN", 10, 1},
    {"BUSMASTER_EOL_INT_EN", 16, 1},
    {"I2C_INT_EN", 17, 1},
    {"MPP_GP_INT_EN", 18, 1},
    {"GUI_IDLE_INT_EN", 19, 1},
    {"VIPH_INT_EN", 24, 1},
    {NULL, 0, 0}
};

static const field_entry_t pm4_buffer_cntl_fields[] = {
    {"PM4_BUFFER_CNTL_NOUPDATE", 27, 1},
    {"PM4_BUFFER_MODE", 28, 4},
    {NULL, 0, 0}
};

static const field_entry_t pm4_micro_cntl_fields[] = {
    {"PM4_MICRO_FREERUN", 30, 1},
    {NULL, 0, 0}
};
...
static const field_entry_t dp_gui_master_cntl_fields[] = {
    {"GMC_SRC_PITCH_OFFSET_CNTL", 0, 1},
    {"GMC_DST_PITCH_OFFSET_CNTL", 1, 1},
    {"GMC_SRC_CLIPPING", 2, 1},
    {"GMC_DST_CLIPPING", 3, 1},
    {"GMC_BRUSH_DATATYPE", 4, 4},
    {"GMC_DST_DATATYPE", 8, 4},
    {"GMC_SRC_DATATYPE", 12, 2},
    {"GMC_BYTE_PIX_ORDER", 14, 1},
    {"GMC_CONVERSION_TEMP", 15, 1},
    {"GMC_ROP3", 16, 8},
    {"GMC_SRC_SOURCE", 24, 3},
    {"GMC_3D_FCN_EN", 27, 1},
    {"GMC_CLR_CMP_CNTL_DIS", 28, 1},
    {"GMC_AUX_CLIP_DIS", 29, 1},
    {"GMC_WR_MSK_DIS", 30, 1},
    {"GMC_LD_BRUSH_Y_X", 31, 1},
    {NULL, 0, 0}
};

static const field_entry_t dp_datatype_fields[] = {
    {"HOST_BIG_ENDIAN_EN", 29, 1},
    {NULL, 0, 0}
};

static const field_entry_t dp_cntl_fields[] = {
    {"DST_X_LEFT_TO_RIGHT", 0, 1},
...
static const field_entry_t default_sc_bottom_right_fields[] = {
    {"DEFAULT_SC_RIGHT", 0, 14},
    {"DEFAULT_SC_BOTTOM", 16, 14},
    {NULL, 0, 0}
};
