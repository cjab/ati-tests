...
bool test_src_pitch_offset_cntl_latching(ati_device_t *dev) {
...
bool test_dst_pitch_offset_cntl_latching(ati_device_t *dev) {
  uint32_t dp_gui_master_cntl;
...
void register_pitch_offset_cntl_tests(void) {
  register_test("SRC pitch offset latches", test_src_pitch_offset_cntl_latching);
  register_test("DST pitch offset latches", test_dst_pitch_offset_cntl_latching);
}
