...
/*
 * Not implemented in QEMU for simplicity. This should only affect
...
//    wr_dst_x_y(dev, 0x0);
//    wr_dst_width_height(dev, (256 << 16) | 1);
//    wr_host_data0(dev, 0x00000000);
//    wr_host_data1(dev, 0x00000000);
//    wr_host_data2(dev, 0x00000000);
//    wr_host_data3(dev, 0x00000000);
...
//    wr_host_data1(dev, 0xbbbbbbbb);
//    wr_host_data2(dev, 0xcccccccc);
